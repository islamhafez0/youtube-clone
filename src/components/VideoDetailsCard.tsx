          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="flex flex-col">
              <h2
                ...
                title={video?.channelDetails.snippet.title}
                tabIndex={0}
              >
                {video?.channelDetails.snippet.title}
              </h2>
        ...
        <div className="flex gap-2 mt-4 sm:mt-0 sm:ml-4 md:ml-9">
          <div className="flex">
            <button
              title="I like this"
              aria-label="Like"
              className="bg-[#ffffff1a] hover:bg-[#fff3] text-[#f1f1f1] flex items-center gap-1 h-10 px-3 rounded-l-full relative after:content-[''] after:absolute after:h-[25px] after:w-[1.4px] after:bg-[#fff3] after:right-0"
            >
          ...
          <button
            title="Share"
            className="bg-[#ffffff1a] hover:bg-[#fff3] text-[#f1f1f1] h-10 px-3 rounded-full flex items-center gap-1"
          >
